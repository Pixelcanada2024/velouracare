...
class ProductController extends Controller
{
    ...
    public function admin_products(Request $request)
    {
        ...
        $products = $products->where('digital', 0)->orderBy('created_at', 'desc')->paginate(25);
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        //Product Stock
        $this->productStockService->updateVariants($product);
    ...
    public function updateNewArrival(Request $request)
    {
        ...
        $product->new_arrival = $request->status;
        $product->save();
    ...
    {
        return $this->frontendProductService->singleProductPage($product);
    }

    public function productsPage(Request $request)
    {
        return $this->frontendProductService->productsPage( $request);
    }

    public function ajaxSearch(Request $request)
    {
        return $this->frontendProductService->ajaxSearch( $request);
    }

  public function getQuickProduct(Product $product)
  {
      return $this->frontendProductService->getQuickProduct($product);
  }
}
