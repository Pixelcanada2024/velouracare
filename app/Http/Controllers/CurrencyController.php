...
class CurrencyController extends Controller
{
    ...
    public function currency(Request $request)
    {
        ...
        $currencies = $currencies->whereIn('code' , ['SAR','AED','OMR','KWD','BHD','QAR','USD'])->paginate(10);

        $active_currencies = Currency::where('status', 1)->whereIn('code' , ['SAR','AED','OMR','KWD','BHD','QAR','USD'])->get();
