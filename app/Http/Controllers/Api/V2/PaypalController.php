...
class PaypalController extends Controller
{
    ...
    // {
    //   return (new \App\Http\Controllers\Payment\PaypalController)->createOrder($request);
    // }

    // public function captureOrder(Request $request)
    // {
    //   return (new \App\Http\Controllers\Payment\PaypalController)->captureOrder($request);
    // }
