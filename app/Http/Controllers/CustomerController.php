...
class CustomerController extends Controller
{
    ...
    public function userInfo($id)
    {
        ...
        $user = User::with([
            'businessInfo.companyCountry',
            'businessInfo.companyState',
            'businessInfo.shopCountry',
            'businessInfo.shopState',
        ])->findOrFail($id);

        return view('backend.customer.customers.user_info', compact('user'));
    }
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        flash(translate('Customer status has been updated successfully'))->success();
        return back();
    }

    public function notificationEmail()
    {
        return view('backend.customer.customers.notification-email');
    }
}
