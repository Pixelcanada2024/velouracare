  ...
  public function sendResetLinkEmail(Request $request)
  {
    ...
    $request->validate(
      ...
      [
        ...
        'email.exists' => customTrans('validator_email_exists'),
            'g-recaptcha-response.required' => customTrans('Please verify that you are not a robot', 'يرجى التأكد أنك لست روبوت'),
      ]
    );
