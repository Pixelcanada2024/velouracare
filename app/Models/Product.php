...
class Product extends Model
{
    ...
    public function frequently_bought_category()
    {
        return $this->belongsToMany(
            ...
            'product_id',
            'category_id'
        )->wherePivotNotNull('category_id');
    }

    public function frequently_bought_category_product_items()
    {
        $category = $this->frequently_bought_category()->first();
    ...
    // Product-based frequently bought items
    public function frequently_bought_product_items()
    {
        return $this->belongsToMany(
            Product::class,
            'frequently_bought_products',
