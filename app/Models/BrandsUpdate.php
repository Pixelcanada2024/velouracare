...
class BrandsUpdate implements ToCollection, WithHeadingRow
{
  ...
  public function collection(Collection $rows)
  {
    ...
    foreach ($rows as $row) {
      ...
      $validator = \Validator::make($rowArray, [
        ...
        'web_banner_id_ar' => 'nullable',
        'mobile_banner_id_ar' => 'nullable',
        'web_banner_id_en' => 'nullable',
        'mobile_banner_id_en' => 'nullable',
    ...
    if (empty($allErrors)) {
      foreach ($validBrands as $data) {
        try {
          ...
          $brand = Brand::where('id', $data['id'])->first() ?? null;
