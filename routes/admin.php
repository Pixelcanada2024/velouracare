...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(BrandBulkUploadController::class)->group(function () {
        ...
        Route::get('/brand-bulk-update', 'edit')->name('brand_bulk_update.index');
        Route::post('/brand-bulk-update/store', 'bulk_update')->name('brand_bulk_update');
    });
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/new_arrival', 'updateNewArrival')->name('products.new-arrival');
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        Route::group(['prefix' => 'bulk-upload/download'], function () {
            ...
            Route::get('/country', 'pdf_download_country')->name('pdf.download_country');
            Route::get('/seller', 'pdf_download_seller')->name('pdf.download_seller');
        });

        //Product Bulk update
        Route::get('/product-bulk-update/index', 'productsUpdateIndex')->name('products_bulk_update.index');
        Route::get('/product-bulk-update/export', 'productsUpdateExport')->name('products_bulk_update.export');
        Route::post('/product-bulk-update/import', 'productsUpdateImport')->name('products_bulk_update.import');
        // update product salla image
        Route::get('/download-product-image/index',  'downloadProductImageIndex')->name('download-product-image.index');
        Route::post('/download-product-image',  'downloadProductImage')->name('download-product-image');

        //Product Stocks Bulk update
        Route::get('/product-stocks-bulk-update/index', 'productStocksUpdateIndex')->name('product_stocks_bulk_update.index');
        Route::get('/product-stocks-bulk-update/export', 'productStocksUpdateExport')->name('product_stocks_bulk_update.export');
        Route::post('/product-stocks-bulk-update/import', 'productStocksUpdateImport')->name('product_stocks_bulk_update.import');
    });
    ...
    // Customer
    Route::get('customers/notification-email', [CustomerController::class, 'notificationEmail'])->name('customers.notification-email');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('/customers/user-info/{id}', 'userInfo')->name('customers.user-info');
        Route::post('/customers/update-status/{id}', 'updateStatus')->name('customers.update_status');
    ...
    Route::group(['prefix' => 'website'], function () {
        ...
        Route::controller(FaqController::class)->group(function () {
            Route::get('/faqs/destroy/{id}', 'destroy')->name('faqs.destroy');
            Route::post('/faqs/update_home_status', 'updateHomeStatus')->name('faqs.update_home_status');
        });

        // FAQ Categories
        Route::resource('faq-categories', FaqCategoryController::class);
        Route::controller(FaqCategoryController::class)->group(function () {
            Route::get('/faq-categories/destroy/{id}', 'destroy')->name('faq-categories.destroy');
        });
    });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/cart-uploaded-excel-files', 'all_cart_uploaded_excel_files')->name('cart_uploaded_excel_files.index');
        ...
        Route::post('/orders/update_shipping_cost', 'update_shipping_cost')->name('orders.update_shipping_cost');
        Route::post('/orders/update_discount_amount', 'update_discount_amount')->name('orders.update_discount_amount');
    ...
    // Promotion Banners
    Route::resource('promotion-banners', PromotionBannerController::class);
    Route::controller(PromotionBannerController::class)->group(function () {
        Route::get('/promotion-banners/edit/{id}', 'edit')->name('promotion-banners.edit');
        Route::get('/promotion-banners/destroy/{id}', 'destroy')->name('promotion-banners.destroy');
    });


    Route::get('marketing/pop-up-marketing', [PromotionBannerController::class, 'popUpMarketing'])->name('marketing.pop-up-marketing');
    // Endpoint to search products for pop up marketing
    Route::get('marketing/pop-up-marketing/search-products', [PromotionBannerController::class, 'searchProductsForPopUpMarketing'])->name('marketing.pop-up-marketing.search-products');
