...
return [
  ...
  'competitive_pricing_description' => 'Our pricing ensures you get the best value without compromising on quality.',
  'fast_delivery_title' => 'Fast & Reliable Delivery',
  'fast_delivery_description' => 'We leverage an efficient logistics network to ensure prompt and accurate fulfillment.',
  'customer_support_title' => 'Dedicated Customer Support',
  'customer_support_description' => 'Our expert team is here to provide personalized assistance every step of the way.',

  'home_partners_in_success_desc' => 'We are proud to partner with these valued clients. Join our extensive network of over 1,000 distribution channels and retailers across the Kingdom',
  ...
  'about_us_our_mission_description_1' => 'Our mission is to be the leading distributor of premium beauty and health products, offering an extensive range of items designed to meet the diverse needs of our clients.',
  'about_us_our_mission_description_2' => 'We strive to create a seamless and efficient wholesale experience that helps our partners thrive in a competitive market. With a commitment to excellence, we deliver products that reflect the latest trends, innovations, and advancements in the beauty and health industry.',

  // What We Offer Section
  'about_us_what_we_offer_title' => 'What We Offer',
  'about_us_what_we_offer_description_1' => 'We pride ourselves on our diverse product selection, which includes:Beauty Products: From skincare essentials and luxurious cosmetics to haircare solutions and personal grooming items, our beauty product range caters to a wide array of preferences and needs.',
  'about_us_what_we_offer_description_2' => 'Health Products: Our health product lineup encompasses dietary supplements, wellness items, and other health-related goods that support a balanced and healthy lifestyle',

  // Our Values Section
  'about_us_our_values_title' => 'our values',
  'about_us_our_values_description' => 'Integrity, reliability, and excellence are at the core of everything we do. We are committed to building lasting relationships with our clients based on trust and mutual success. Your satisfaction is our top priority, and we work tirelessly to ensure that you receive the best products and service in the industry.',
  ...
  'about_us_why_best_title' => 'Why We are The Best Distributors',
  ...
  'work_hours' => "9am - 5pm EST (Mon-Friday)",
  'address' => "Kingdom of Saudi Arabia – Riyadh – Al-Malaz – Salah Al-Din Al-Ayyubi Road Platinum Center Office No.: 406 – Riyadh 12811",
  ...
  "email_approved_how_to_get_started_line_2" => "Explore our Brands and Product.",
  ...
  "new_quotation_request_request_client_company"=>"Client Company:",
  "new_quotation_request_request_client_email"=>"Client Email:",
  "new_quotation_request_request_client_phone"=>"Client Phone:",
  "new_quotation_request_request_client_date_submitted"=>"Date Submitted:",
  "new_quotation_request_uploaded_files"=>"Uploaded Files:",
  "new_quotation_request_uploaded_files_desc"=>"An Excel file containing the desired products has been uploaded by the client.",
  "new_quotation_request_next_steps"=>"Next Steps:",
  "new_quotation_request_next_steps_1"=>"Review the attached Excel file to understand the client's product requirements.",
  "new_quotation_request_next_steps_2"=>"Generate a detailed quotation based on our wholesale pricing.",
  ...
  // Validator messages
  // Registration
  'validator_name_required' => 'The name field is required.',
  'validator_name_string' => 'The name must be a string.',
  'validator_name_max' => 'The name may not be greater than 255 characters.',
  'validator_email_required' => 'The email field is required.',
  'validator_email_email' => 'The email must be a valid email address.',
  'validator_email_unique' => 'The email has already been taken.',
  'validator_email_max' => 'The email may not be greater than 255 characters.',
  'validator_phone_required' => 'The phone field is required.',
  'validator_phone_string' => 'The phone must be a string.',
  'validator_phone_max' => 'The phone may not be greater than 20 characters.',
  'validator_password_required' => 'The password field is required.',
  'validator_password_string' => 'The password must be a string.',
  'validator_password_min' => 'The password must be at least 6 characters.',
  'validator_address_line_one_string' => 'The address line one must be a string.',
  'validator_address_line_one_max' => 'The address line one may not be greater than 255 characters.',
  'validator_address_line_two_string' => 'The address line two must be a string.',
  'validator_address_line_two_max' => 'The address line two may not be greater than 255 characters.',
  'validator_country_id_required' => 'The country field is required.',
  'validator_country_id_exists' => 'The selected country is invalid.',
  'validator_city_required' => 'The city field is required.',
  'validator_city_string' => 'The city must be a string.',
  'validator_city_max' => 'The city may not be greater than 100 characters.',
  'validator_postal_code_string' => 'The postal code must be a string.',
  'validator_postal_code_max' => 'The postal code may not be greater than 20 characters.',
  'validator_agree_required' => 'The agree field is required.',
  'validator_agree_accepted' => 'You must agree to the Privacy Policy and Terms of Sales.',
  'validator_company_name_required' => 'The company name field is required.',
  'validator_company_name_string' => 'The company name must be a string.',
  'validator_company_name_max' => 'The company name may not be greater than 255 characters.',
  'validator_store_link_required' => 'The store link field is required.',
  'validator_store_link_url' => 'Please provide a valid URL for your store link.',
  'validator_store_link_max' => 'The store link may not be greater than 255 characters.',
  'validator_business_id_required' => 'The business id field is required.',
  'validator_business_id_string' => 'The business id must be a string.',
  'validator_business_id_max' => 'The business id may not be greater than 255 characters.',
  'validator_business_proof_assets_required' => 'Business proof documents are required.',
  'validator_business_proof_assets_array' => 'Business proof must be an array of files.',
  'validator_business_proof_assets_min' => 'At least 1 business proof document is required.',
  'validator_business_proof_assets_max' => 'You can upload maximum 5 business proof documents.',
  'validator_business_proof_assets_file' => 'Each business proof must be a valid file.',
  'validator_business_proof_assets_mimes' => 'Each business proof must be a file of type: jpg, jpeg, png, webp, pdf.',
  'validator_business_proof_assets_max_size' => 'Each business proof file may not be greater than 10MB.',
  'validator_business_type_required' => 'The business type field is required.',
  'validator_business_type_string' => 'The business type must be a string.',
  'validator_business_type_in' => 'The selected business type is invalid.',
  'validator_find_us_required' => 'The find us field is required.',
  'validator_find_us_integer' => 'The find us must be an integer.',
  'validator_find_us_in' => 'The selected find us is invalid.',
  'validator_wholesale_agree_required' => 'The wholesale agree field is required.',
  'validator_wholesale_agree_accepted' => 'You must confirm that all information provided is accurate.',
  'validator_g_recaptcha_response_required' => 'The g recaptcha response field is required.',
  'validator_state_string' => 'The state must be a string.',
  'validator_state_max' => 'The state may not be greater than 100 characters.',

  // Forgot Password
  'validator_email_required' => 'Email field is required.',
  'validator_email_email' => 'Email must be a valid email address.',
  'validator_email_exists' => 'The email you entered does not exist.'
