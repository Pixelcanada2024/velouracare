        ...
        <div className="w-[380px]">
          <div>
            ...
            <form method="POST" action={route("subscribers.store")}>
              ...
              <button className="text-sm sm:text-base cursor-pointer w-full mt-4 font-bold text-white px-4 py-[12px] sm:py-[13px] bg-[#004AAD] border border-[#555555] rounded-full focus:outline-none uppercase">
                {tr["subscribe_now"]}
              </button>
            </form>
