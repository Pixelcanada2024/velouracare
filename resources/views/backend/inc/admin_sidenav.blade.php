        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
                  ...
                  <span class="aiz-side-nav-text">{{ translate('Digital Products') }}</span>
                            ...
                            @can('product_bulk_import')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('products_bulk_update.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Products Bulk Update') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('download-product-image.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Update Product Images') }}</span>
                                    </a>
                                </li>
                            @endcan
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @can('brand_bulk_upload')
                                            ...
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('brand_bulk_update.index') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{ translate('Brand Bulk Update') }}</span>
                                                </a>
                                            </li>
                                        @endcan
                                    </ul>
                ...
                @canany(['view_all_orders', 'view_inhouse_orders', 'view_seller_orders', 'view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan --}}
                            @can('view_all_cart_uploaded_excel_files')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('cart_uploaded_excel_files.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['cart_uploaded_excel_files.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Cart Uploaded Excel Files') }}</span>
                                </a>
                            </li>
                            @endcan
                        </ul>
                ...
                @canany(['view_all_customers', 'view_classified_products', 'view_classified_packages'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            <li class="aiz-side-nav-item">
                              <a href="{{ route('customers.notification-email') }}"
                                  class="aiz-side-nav-link {{ areActiveRoutes(['customers.notification-email']) }}">
                                  <span class="aiz-side-nav-text">{{ translate('Registration Notification Email') }}</span>
                              </a>
                          </li>
              ...
              @endcan --}}
                ...
                @canany(['view_all_flash_deals', 'view_all_dynamic_popups', 'view_all_custom_alerts',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @if (auth()->user()->can('view_all_coupons'))
                            ...
                            @endif
                            <li class="aiz-side-nav-item">
                              <a href="{{ route('promotion-banners.index') }}"
                                  class="aiz-side-nav-link {{ areActiveRoutes(['promotion-banners.index', 'promotion-banners.create', 'promotion-banners.edit']) }}">
                                  <span class="aiz-side-nav-text">{{ translate('Promotion Banners') }}</span>
                              </a>
                          </li>
                          <li class="aiz-side-nav-item">
                            <a href="{{ route('marketing.pop-up-marketing') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['marketing.pop-up-marketing']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Pop Up Marketing') }}</span>
                            </a>
                          </li>
                        </ul>
                    </li>
                ...
                <!-- Support -->
                @canany(['view_all_support_tickets', 'view_all_product_conversations',
                'view_all_product_queries' , 'view_all_faqs' , 'view_all_contacts'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            @endif --}}
                            ...
                            @can('view_all_faqs')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('faqs.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['faqs.index', 'faqs.create', 'faqs.edit', 'faq-categories.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('FAQs') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('footer_setup')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('website.footer', ['lang' => App::getLocale()]) }}"
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Website Info') }}</span>
                                    </a>
                                </li>
                            @endcan
