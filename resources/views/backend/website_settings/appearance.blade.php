                ...
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <small class="text-muted">{{ translate('Will be used in admin panel side menu. Minimum dimensions required: 191px width X 54px height.') }}</small>
                        </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-3 col-from-label">{{translate('Mobile System Logo - White')}}</label>
                      <div class="col-sm-8">
                          <div class="input-group" data-toggle="aizuploader" data-type="image">
                              <div class="input-group-prepend">
                                  <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                              ...
                              <div class="form-control file-amount">{{ translate('Choose Files') }}</div>
                              <input type="hidden" name="types[]" value="mobile_system_logo_white">
                              <input type="hidden" name="mobile_system_logo_white" value="{{ get_setting('mobile_system_logo_white') }}" class="selected-files">
                          </div>
                          <div class="file-preview box sm"></div>
                          <small class="text-muted">{{ translate('Will be used in admin panel side menu. Minimum dimensions required: 60px width X 60px height.') }}</small>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-3 col-from-label">{{translate('Arabic System Logo - White')}}</label>
                      <div class="col-sm-8">
                          <div class="input-group" data-toggle="aizuploader" data-type="image">
                              <div class="input-group-prepend">
                                  <div class="input-group-text bg-soft-secondary">{{ translate('Browse') }}</div>
                              ...
                              <div class="form-control file-amount">{{ translate('Choose Files') }}</div>
                              <input type="hidden" name="types[]" value="system_ar_logo_white">
                              <input type="hidden" name="system_ar_logo_white" value="{{ get_setting('system_ar_logo_white') }}" class="selected-files">
                          </div>
                          <div class="file-preview box sm"></div>
                          <small class="text-muted">{{ translate('Minimum dimensions required: 191px width X 54px height.') }}</small>
                      </div>
                  </div>
                    <!-- System Logo - Black -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="file-preview box sm"></div>
                            <small class="text-muted">{{ translate('Will be used in Admin login page, Seller login page & Delivery Boy login page. Minimum dimensions required: 191px width X 54px height.') }}</small>
                        </div>
                    </div>
                    <!-- System Timezone -->
                    <div class="form-group row">
