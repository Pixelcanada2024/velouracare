        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 class="mb-0 h6">{{ translate('Tax Settings') }}</h1>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{ translate('Tax Value') }} ( % )</label>
                            <div class="col-sm-8">
                                <input type="hidden" name="types[]" value="tax_value">
                                <input type="text" name="tax_value" class="form-control"
                                    placeholder="{{ translate('Tax Value') }}" value="{{ get_setting('tax_value') }}">
                            </div>
                        </div>
                        <!-- Update Button -->
                ...
                <tr>
                    ...
                    <td>
                        <label class="aiz-switch aiz-switch-success mb-0">
                            <input onchange="update_tax_status(this)" value="{{ $tax->id }}" type="checkbox" <?php if ($tax->tax_status == 1) {
                                echo 'checked';
                            } ?> >
