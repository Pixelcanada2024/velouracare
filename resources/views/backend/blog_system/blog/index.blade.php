                ...
                <thead>
                    <tr>
                        ...
                        <th>{{ translate('Title') }}
                            @if ($isNotAmerica)
                                [{{ $lang }}]
                                <span class="badge badge-info" style="cursor: pointer" title="hover to show translation">
                                    {{ $hiddenLang }}
                                </span>
                            @endif
                        </th>
                        <th data-breakpoints="lg">{{ translate('Category') }}
                            @if ($isNotAmerica)
                                [{{ $lang }}]
                                <span class="badge badge-info" style="cursor: pointer" title="hover to show translation">
                                    {{ $hiddenLang }}
                        ...
                        <th data-breakpoints="lg">{{ translate('Short Description') }}
                            @if ($isNotAmerica)
                                [{{ $lang }}]
                                <span class="badge badge-info" style="cursor: pointer" title="hover to show translation">
                                    {{ $hiddenLang }}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($isNotAmerica)
                                    <span class="badge badge-info" style="cursor: pointer"
                                        title="{{ $blog->title_trans[$hiddenLang] ?? 'no translated text' }}">
                                        {{ $hiddenLang }}
                                    </span>
                                @endif
                            ...
                            <td>
                                @if ($blog->category != null)
                                    ...
                                    @if ($isNotAmerica)
                                        <span class="badge badge-info" style="cursor: pointer"
                                            title="{{ $blog->category->category_name_trans[$hiddenLang] ?? 'no translated text' }}">
                                            {{ $hiddenLang }}
                                        </span>
                                    @endif
                                @else
                            ...
                            <td>
                                ...
                                @if ($isNotAmerica)
                                    <span class="badge badge-info" style="cursor: pointer"
                                        title="{{ $blog->short_description_trans[$hiddenLang] ?? 'no translated text' }}">
                                        {{ $hiddenLang }}
                                    </span>
                                @endif
