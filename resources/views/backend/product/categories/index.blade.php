            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th>{{ translate('Name') }}
                            @if ($isNotAmerica)
                                [{{ $lang }}]<span class="badge badge-info" style="cursor: pointer"
                    ...
                    @foreach ($categories as $key => $category)
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                {{ $category->category_translations->where('lang', $lang)->first()?->name }}
                                @if ($isNotAmerica)
                                    <span class="badge badge-info" style="cursor: pointer"
                                        title="{{ $category->category_translations->where('lang', $hiddenLang)->first()?->name ?? 'no translated text' }}">
                                        {{ $hiddenLang }}
                                    </span>
                                @endif
