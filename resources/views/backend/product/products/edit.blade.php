  ...
  <div class="d-sm-flex">
    ...
    <div class="page-side-nav c-scrollbar-light px-3 py-2">
      <ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
        <!-- General -->
        <li class="nav-item">
          <a class="nav-link" id="general-tab" href="#general" data-toggle="tab" data-target="#general" type="button"
        ...
        <!-- SEO -->
        <li class="nav-item">
          <a class="nav-link" id="seo-tab" href="#seo" data-toggle="tab" data-target="#seo" type="button" role="tab"
        ...
        <!-- Shipping -->
        <li class="nav-item">
          <a class="nav-link" id="shipping-tab" href="#shipping" data-toggle="tab" data-target="#shipping" type="button"
        ...
        <!-- Warranty -->
        {{-- <li class="nav-item">
          <a class="nav-link" id="warranty-tab" href="#warranty" data-toggle="tab" data-target="#warranty" type="button"
        ...
        <li class="nav-item">
          <a class="nav-link" id="frequenty-bought-product-tab" href="#frequenty-bought-product" data-toggle="tab"
            data-target="#frequenty-bought-product" type="button" role="tab" aria-controls="frequenty-bought-product"
            aria-selected="false">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="general" role="tabpanel" aria-labelledby="general-tab">
            <div class="bg-white p-3 p-sm-2rem">
              <!-- Product Information -->
              <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Product
                Information')}}</h5>
              <div class="w-100">
                <div class="row">
                  <div class="col-xxl-7 col-xl-6">
                    ...
                    <div class="form-group row" id="brand">
                      ...
                      <div class="col-xxl-9">
                        ...
                        <small class="text-muted">{{translate("You can choose a brand if you'd like to display your
                          product by brand.")}}</small>
                      </div>
                    </div>
                    <!-- Unit -->
                    ...
                    <!-- Weight -->
                    <div class="form-group row">
                      <label class="col-xxl-3 col-from-label fs-13">{{translate('Weight')}} <small>({{ translate('In
                          Kg') }})</small></label>
                      <div class="col-xxl-9">
                    ...
                    <!-- Quantity -->
                    <div class="form-group row">
                      <label class="col-xxl-3 col-from-label fs-13">{{translate('Minimum Purchase Qty')}} <span
                          class="text-danger">*</span></label>
                      <div class="col-xxl-9">
                        <input type="number" lang="en" class="form-control @error('min_qty') is-invalid @enderror"
                          name="min_qty" value="@if($product->min_qty <= 1){{1}}@else{{$product->min_qty}}@endif"
                          min="1">
                        <small class="text-muted">{{translate("The minimum quantity needs to be purchased by your
                          customer.")}}</small>
                      </div>
                    </div>
                    <!-- Tags -->
                    <div class="form-group row">
                      ...
                      <div class="col-xxl-9">
                        <input type="text" class="form-control aiz-tag-input" name="tags[]" id="tags"
                          ...
                          data-role="tagsinput">
                        <small class="text-muted">{{translate('This is used for search. Input those words by which
                        ...
                        <h6 class="float-right fs-13 mb-0">
                          ...
                          <span class="position-relative main-category-info-icon">
                            ...
                            <span class="main-category-info bg-soft-info p-2 position-absolute d-none border">{{
                              translate('This will be used for commission based calculations and homepage category wise
                              product Show.') }}</span>
                          </span>
                        </h6>
                      </div>
              ...
              <h5 class="mb-3 mt-5 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Refund')}}
              </h5>
              <div class="w-100">
                <!-- Refundable -->
                <div class="form-group row">
              ...
              <!-- Status -->
              <h5 class="mb-3 mt-5 pb-3 fs-17 fw-700 d-none" style="border-bottom: 1px dashed #e4e5eb;">
                {{translate('Status')}}</h5>
              <div class="w-100 d-none">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    ...
                    <small class="text-muted">{{ translate('If you enable this, this product will be granted as a
                      featured product.') }}</small>
                  </div>
                </div>
                <!-- Todays Deal -->
                <div class="form-group row">
                  <label class="col-md-3 col-from-label">{{translate('Top Deal')}}</label>
                  <div class="col-md-9">
                    <label class="aiz-switch aiz-switch-success mb-0 d-block">
                      <input type="checkbox" name="todays_deal" value="1" @if($product->todays_deal == 1) checked
                      @endif>
                      <span></span>
                    </label>
                    <small class="text-muted">{{ translate('If you enable this, this product will be granted as a top
                      deal product.') }}</small>
                  </div>
                </div>
                <!-- Todays Deal -->
                <div class="form-group row">
                  <label class="col-md-3 col-from-label">{{translate('New Arrival')}}</label>
                  <div class="col-md-9">
                    <label class="aiz-switch aiz-switch-success mb-0 d-block">
                      <input type="checkbox" name="new_arrival" value="1" @if($product->new_arrival == 1) checked
                      @endif>
                      <span></span>
                    </label>
                    <small class="text-muted">{{ translate('If you enable this, this product will be granted as a new
                      arrival product.') }}</small>
                  </div>
                </div>
              </div>
              ...
              <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700 d-none" style="border-bottom: 1px dashed #e4e5eb; ">
                ...
                <small class="text-muted">({{ translate('If you want to select this product as a flash deal, you can use
                  it') }})</small>
              </h5>
              <div class="w-100 d-none">
                <!-- Add To Flash -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xxl-9">
                    <input type="number" name="flash_discount" value="{{ $product->discount }}" min="0" step="0.01"
                      class="form-control">
                  </div>
                </div>
                <!-- Discount Type -->
              ...
              <!-- Vat & TAX -->
              <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Vat &
                TAX')}}</h5>
              <div class="w-100">
          ...
          <div class="tab-pane fade" id="files_and_media" role="tabpanel" aria-labelledby="files-and-media-tab">
            <div class="bg-white p-3 p-sm-2rem">
              <!-- Product Files & Media -->
              <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Product Files &
                Media')}}</h5>
              <div class="w-100">
                <!-- Gallery Images -->
                <div class="form-group row d-none">
                  ...
                  <div class="col-md-9">
                    ...
                    <small class="text-muted">{{translate('These images are visible in product details page gallery.
                      Minimum dimensions required: 900px width X 900px height.')}}</small>
                  </div>
                </div>
                <!-- Thumbnail Image -->
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    ...
                    <small class="text-muted">{{translate("This image is visible in all product box. Minimum dimensions
                      required: 195px width X 195px height. Keep some blank space around main object of your image as we
              ...
              <div class="form-group row d-none">
                ...
                <div class="col-md-9">
                  ...
                  <small class="text-muted">{{translate("Use proper link without extra parameter. Don't use short share
                    link/embeded iframe code.")}}</small>
                </div>
              </div>
              <!-- PDF Specification -->
              <div class="form-group row d-none">
          ...
          <div class="tab-pane fade" id="price_and_stocks" role="tabpanel" aria-labelledby="price-and-stocks-tab">
            <div class="bg-white p-3 p-sm-2rem">
              <!-- tab Title -->
              <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Product price &
                stock')}}</h5>
              <div class="w-100">
                <!-- Colors -->
                <div class="form-group row gutters-5 d-none">
                  ...
                  <div class="col-md-8">
                    <select class="form-control aiz-selectpicker" data-live-search="true"
                      data-selected-text-format="count" name="colors[]" id="colors" multiple value="">
                  ...
                  <div class="col-md-1">
                    <label class="aiz-switch aiz-switch-success mb-0">
                      <input value="1" type="checkbox" name="colors_active" <?php if
                        (count(json_decode($product->colors)) > 0) echo "checked"; ?> >
                      <span></span>
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group row gutters-5 d-none">
                  ...
                  <div class="col-md-8">
                    <select name="choice_attributes[]" id="choice_attributes" data-selected-text-format="count"
                      ...
                      data-placeholder="{{ translate('Choose Attributes') }}" value="">
                      {{-- @foreach (\App\Models\Attribute::all() as $key => $attribute)
                      <option value="{{ $attribute->id }}" @if($product->attributes != null && in_array($attribute->id,
                        json_decode($product->attributes, true))) selected @endif>{{ $attribute->getTranslation('name')
                        }}</option>
                      @endforeach --}}
                    </select>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <select class="form-control aiz-selectpicker attribute_choice" data-live-search="true"
                        name="choice_options_{{ $choice_option->attribute_id }}[]" data-selected-text-format="count"
                        multiple>
                        {{-- @foreach (\App\Models\AttributeValue::where('attribute_id',
                        $choice_option->attribute_id)->get() as $row)
                        <option value="{{ $row->value }}" @if( in_array($row->value, $choice_option->values)) selected
                          @endif>
                          {{ $row->value }}
                        </option>
                        @endforeach --}}
                ...
                <div class="form-group row d-none">
                  ...
                  <div class="col-md-6">
                    <input type="text" placeholder="{{translate('Unit price')}}" name="unit_price"
                      class="form-control @error('unit_price') is-invalid @enderror" value="{{$product->unit_price}}">
                  </div>
                </div>
                ...
                <div class="form-group row d-none">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control aiz-date-range" @if($product->discount_start_date &&
                    $product->discount_end_date) value="{{ $start_date.' to '.$end_date }}" @endif name="date_range"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="number" lang="en" min="0" value="{{ $product->earn_point }}" step="0.01"
                      placeholder="{{ translate('1') }}" name="earn_point" class="form-control">
                  </div>
                </div>
                @endif

                <div id="show-hide-div" class="d-none">
                  <!-- Quantity -->
                  <div class="form-group row d-none" id="quantity">
                    <label class="col-md-3 col-from-label">{{translate('Quantity')}} <span
                        class="text-danger">*</span></label>
                    <div class="col-md-6">
                      <input type="number" lang="en" value="{{ $product->stocks?->first()?->qty ?? 10  }}" step="1"
                  ...
                  <div class="form-group row d-none">
                    ...
                    <div class="col-md-6">
                      <input type="text" placeholder="{{ translate('SKU') }}"
                        value="{{ optional($product->stocks->first())->sku }}" name="sku" class="form-control">
                    </div>
                  </div>
                </div>
                <!-- External link -->
                ...
                <div class="form-group row d-none">
                  ...
                  <div class="col-md-9">
                    <input type="text" placeholder="{{ translate('External link button text') }}"
                      name="external_link_btn" value="{{ $product->external_link_btn }}" class="form-control">
                    <small class="text-muted">{{translate('Leave it blank if you do not use external site
                      link')}}</small>
                  </div>
                </div>
                ...
                <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Product
                  Info')}}</h5>
                <div class="form-group row d-none">
                  <label class="col-md-3 col-from-label">{{translate('Has Variants')}}</label>
                  <div class="col-md-9">
                    <label class="aiz-switch aiz-switch-success mb-0">
                      <input type="checkbox" name="has_variants" id="has_variants" checked>
                      <span></span>
                    </label>
                  </div>
                </div>
                <div id="variant_section" style="display: block;">
                  ...
                  <div id="variants_container">
                    {{-- ALL VARIANTS CAN NOW BE EDITED INCLUDING THE FIRST ONE --}}
                    @if($product->stocks->where('variant_name', '!=', null)->count() > 0)
                    @foreach($product->stocks->where('variant_name', '!=', null) as $key => $stock)
                    <div class="variant-item card p-3 mb-3" id="variant_{{ $key + 1 }}">
                      <div class="form-group row w-100">
                        <div class="col-md-4 d-none">


                          <label class="col-form-label">{{translate('Variant Name')}}</label>
                          <input type="text" name="variant_name[]" class="form-control"
                            value="{{ $stock->variant_name }}" placeholder="{{translate('Enter variant name')}}">

                          <input type="hidden" name="variant_id[]" value="{{ $stock->id }}">

                          @if($key == 0)
                          <small class="text-info">{{translate('This is the main product variant. It cannot be
                            deleted.')}}</small>
                          @endif

                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Price Per Piece')}} <span
                              class="text-danger">*</span></label>
                          <input type="number" name="variant_price[]" step="0.01" min="0" class="form-control"
                            value="{{ $stock->price }}" placeholder="{{translate('Enter Price')}}" required>
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('MSRP  Per Piece')}} <span class="text-danger">*</span></label>
                          <input type="number" name="variant_msrp[]" step="0.01" min="0" class="form-control"
                            value="{{ $stock->msrp }}" required placeholder="{{translate('Enter MSRP')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('SKU')}} <span class="text-danger">*</span></label>
                          <input type="text" name="variant_sku[]" class="form-control" value="{{ $stock->sku }}"
                            required placeholder="{{translate('Enter SKU')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Barcode')}} <span
                              class="text-danger">*</span></label>
                          <input type="text" name="variant_barcode[]" class="form-control" value="{{ $stock->barcode }}"
                            required placeholder="{{translate('Enter barcode')}}">
                        </div>
                      ...
                      <div class="form-group row w-100">
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Stock')}} <span
                              class="text-danger">*</span></label>
                          <input type="number" name="variant_qty[]" min="0" class="form-control"
                            value="{{ $stock->qty }}" required placeholder="{{translate('Enter Stock')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Quantity in box')}} (Pcs) <span
                              class="text-danger">*</span></label>
                          <input type="number" name="variant_box_qty[]" min="0" class="form-control"
                            value="{{ $stock->box_qty }}" required placeholder="{{translate('Enter box quantity')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Lead Time')}} <span
                              class="text-danger">*</span></label>
                          <input type="text" name="variant_lead_time[]" class="form-control"
                            value="{{ $stock->lead_time }}" required placeholder="{{translate('2-3 Weeks')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Made in Country')}} <span
                              class="text-danger">*</span></label>
                          <select class="form-control aiz-selectpicker" data-live-search="true"
                            name="variant_made_in_country_id[]" id="variant_made_in_country_id_{{ $key + 1 }}" required>
                            <option value="">{{ translate('Select Country') }}</option>
                            @foreach (\App\Models\Country::orderBy('name', 'asc')->get() as $country)
                            <option value="{{ $country->id }}" @if($stock->made_in_country_id == $country->id) selected
                              @endif>
                              {{ $country->name }}
                            </option>
                            @endforeach
                      ...
                      <div class="form-group row">
                        <div class="col-md-6 pr-4">
                          <label class="col-form-label">{{ translate('Available Document') }} <span
                              class="text-danger">*</span></label>
                          <select class="form-control aiz-selectpicker" name="variant_available_document[]" required>
                            <option value="">{{ translate('Select Document') }}</option>
                            <option value="0" @if($stock->available_document === 0) selected @endif>
                              {{ translate('Commercial Invoice') }}
                            </option>
                            <option value="1" @if($stock->available_document === 1) selected @endif>
                              {{ translate('MSDS') }}
                            </option>
                            <option value="2" @if($stock->available_document === 2) selected @endif>
                              {{ translate('MSDS, Commercial Invoice') }}
                            </option>
                          </select>
                        </div>
                      ...
                      <div class="form-group row d-none">
                        <div class="col-md-2">
                          ...
                          <select class="form-control aiz-selectpicker" data-live-search="true"
                            data-selected-text-format="count" name="variant_color_id[]"
                            id="variant_color_id_{{ $key + 1 }}">
                            <option value="">{{ translate('No Color') }}</option>
                            @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $color)
                            <option value="{{ $color->id }}" @if($stock->color_id == $color->id) selected @endif
                              data-content="<span><span class='size-15px d-inline-block mr-2 rounded border'
                                  style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>">
                            </option>
                            @endforeach
                          </select>
                        </div>
                        ...
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Special Discount')}}</label>
                          <div class="d-flex">
                            <select class="form-control aiz-selectpicker" name="has_special_discount[]"
                              onchange="toggleSpecialDiscount({{ $key + 1 }})">
                              <option value="0" @if(!$stock->has_special_discount) selected @endif>
                                {{translate('Apply General Product Discount')}}
                              </option>
                              <option value="1" @if($stock->has_special_discount) selected @endif>
                        ...
                        <!-- Special Discount Fields - Initially Hidden -->
                        <div id="special_discount_fields_{{ $key + 1 }}"
                          class="col-md-6 @if(!$stock->has_special_discount) d-none @endif">
                          <div class="row">
                            <div class="col-md-6">
                              <label class="col-form-label">{{translate('Discount')}}</label>
                              <input type="number" name="variant_discount[]" min="0" step="0.01" class="form-control"
                                value="{{ $stock->discount ?? 0 }}">
                            </div>
                            <div class="col-md-6">
                              <label class="col-form-label">{{translate('Discount Type')}}</label>
                              <select class="form-control aiz-selectpicker" name="variant_discount_type[]">
                                <option value="amount" @if($stock->discount_type == 'amount') selected
                                  @endif>{{translate('Flat')}}</option>
                                <option value="percent" @if($stock->discount_type == 'percent') selected
                                  @endif>{{translate('Percent')}}</option>
                              </select>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="form-group row d-none">
                        <div class="col-md-4">
                          ...
                          <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="variant_img[]" class="selected-files"
                              value="{{ $stock->image }}">
                          </div>
                          <div class="file-preview box sm">
                            @if($stock->image)
                            <div class="card card-file aiz-uploader-select" data-value="{{ $stock->image }}">
                ...
                {{-- END OF PRODUCT VARIANTS SECTION --}}
                <!-- sku combination (old system - hidden) -->
              ...
              <!-- Low Stock Quantity -->
              <h5 class="mb-3 pb-3 fs-17 fw-700 d-none" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Low
                Stock Quantity Warning')}}</h5>
              ...
              <h5 class="mb-3 pb-3 fs-17 fw-700 d-none" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Stock
                Visibility State')}}</h5>
              <div class="w-100 d-none">
                <!-- Show Stock Quantity -->
                <div class="form-group row">
          ...
          <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
            <div class="bg-white p-3 p-sm-2rem">
              <!-- tab Title -->
              <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('SEO Meta
                Tags')}}</h5>
              <div class="w-100">
                <!-- Meta Title -->
                <div class="form-group row">
          ...
          <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">
            <div class="bg-white p-3 p-sm-2rem">
              ...
              <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Shipping
                Configuration')}}</h5>
              <div class="w-100">
                <!-- Cash On Delivery -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <label class="aiz-switch aiz-switch-success mb-0">
                      <input type="checkbox" name="cash_on_delivery" value="1" @if($product->cash_on_delivery == 1)
                      checked @endif>
                      <span></span>
                    </label>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input type="number" lang="en" min="0" value="{{ $product->shipping_cost }}" step="0.01"
                        placeholder="{{ translate('Shipping cost') }}" name="flat_shipping_cost" class="form-control">
                    </div>
                  </div>
                </div>
              ...
              <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Estimate
                Shipping Time')}}</h5>
              <div class="w-100">
                <div class="form-group row">
          ...
          <div class="tab-pane fade" id="warranty" role="tabpanel" aria-labelledby="warranty-tab">
            <div class="bg-white p-3 p-sm-2rem">
              <h5 class="mb-3 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">{{translate('Warranty')}}
              </h5>
              <div class="form-group row">
                <label class="col-md-2 col-from-label">{{translate('Warranty')}}</label>
                <div class="col-md-10">
                  <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" name="has_warranty" onchange="warrantySelection()" @if($product->has_warranty
                    == 1) checked @endif>
                    <span></span>
                  </label>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-10">
                    <select class="form-control aiz-selectpicker" name="warranty_id" id="warranty_id"
                      data-selected="{{ $product->warranty_id }}" data-live-search="true" @if($product->has_warranty ==
                      1) required @endif
                      >
              ...
              <div class="w-100">
                <div class="d-flex mb-4">
                  <div class="radio mar-btm mr-5 d-flex align-items-center">
                    <input id="fq_bought_select_products" type="radio" name="frequently_bought_selection_type"
                      value="product" onchange="fq_bought_product_selection_type()"
                      @if($product->frequently_bought_selection_type == 'product') checked @endif
                    >
                    <label for="fq_bought_select_products" class="fs-14 fw-700 mb-0 ml-2">{{translate('Select
                      Product')}}</label>
                  </div>
                  <div class="radio mar-btm mr-3 d-flex align-items-center">
                    <input id="fq_bought_select_category" type="radio" name="frequently_bought_selection_type"
                      value="category" onchange="fq_bought_product_selection_type()"
                      @if($product->frequently_bought_selection_type == 'category') checked @endif
                    >
                    <label for="fq_bought_select_category" class="fs-14 fw-700 mb-0 ml-2">{{translate('Select
                      Category')}}</label>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                              ...
                              <tr class="remove-parent">
                                ...
                                <td class="w-150px pl-0" style="vertical-align: middle;">
                                  <p class="d-block size-48px">
                                    <img
                                      src="{{ uploaded_asset($fQBproduct->frequently_bought_product->thumbnail_img) }}"
                                      alt="{{ translate('Image')}}" class="h-100 img-fit lazyload"
                                ...
                                <td style="vertical-align: middle;">{{
                                  $fQBproduct->frequently_bought_product->main_category->name ?? translate('Category Not
                                  Found') }}</td>
                    ...
                    <div class="fq_bought_select_category_div d-none">
                      @php
                      $fq_bought_product_category_id = $product->frequently_bought_products()->where('category_id','!=',
                      null)->first();
                      $fqCategory = $fq_bought_product_category_id != null ? $fq_bought_product_category_id->category_id
                      : null;
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <select class="form-control aiz-selectpicker"
                            data-placeholder="{{ translate('Select a Category')}}" name="fq_bought_product_category_id"
                            data-live-search="true" data-selected="{{ $fqCategory }}" required>
                            @foreach ($categories as $category)
...
<script type="text/javascript">
  $(document).ready(function (){
        ...
        // Initialize special discount fields visibility on page load
        @if($product->stocks->where('variant_name', '!=', null)->count() > 0)
          @foreach($product->stocks->where('variant_name', '!=', null) as $key => $stock)
            toggleSpecialDiscount({{ $key + 1 }});
          @endforeach
        @endif
    });
    ...
    // Special Discount Toggle
    function toggleSpecialDiscount(variantId) {
        const selectBox = document.querySelector(`#variant_${variantId} select[name="has_special_discount[]"]`);
        const discountFields = document.getElementById(`special_discount_fields_${variantId}`);
        
        if (selectBox && discountFields) {
    ...
    function toggleVariantSection() {
        if (document.getElementById('has_variants').checked) {
            document.getElementById('variant_section').style.display = 'block';
            document.getElementById('show-hide-div').style.display = 'none';
        } else {
            document.getElementById('variant_section').style.display = 'none';
            document.getElementById('show-hide-div').style.display = 'block';
        }
    }

    let variantCount = {{ $product->stocks->where('variant_name', '!=', null)->count() }};
    function addVariant() {
        variantCount++;
        const container = document.getElementById('variants_container');
        const variantHtml = `
            <div class="variant-item card p-3 mb-3" id="variant_${variantCount}">
                <div class="form-group row">
                    <div class="col-md-4">
                        <label class="col-form-label">{{translate('Variant Name')}}</label>
                        <input type="text" name="variant_name[]" class="form-control" placeholder="{{translate('Enter variant name')}}" required>
                    </div>
                    <div class="col-md-2">
                        <label class="col-form-label">{{translate('Price')}}</label>
                        <input type="number" name="variant_price[]" step="0.01" min="0" class="form-control" required>
                    </div>
                    <div class="col-md-2">
                        <label class="col-form-label">{{translate('SKU')}}</label>
                        <input type="text" name="variant_sku[]" class="form-control">
                    </div>
                    <div class="col-md-2">
                        <label class="col-form-label">{{translate('Quantity')}}</label>
                        <input type="number" name="variant_qty[]" min="0" class="form-control" required>
                    </div>
                    
                    <div class="col-md-1">
                        <label class="col-form-label">&nbsp;</label>
                        <button type="button" class="btn btn-danger btn-sm d-block" onclick="removeVariant(${variantCount})">
                            <i class="las la-trash"></i>
                        </button>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-2">
                        ...
                        <select class="form-control aiz-selectpicker"
                                ...
                                id="variant_color_id_${variantCount}">
                            <option value="">{{ translate('No Color') }}</option>
                            @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $key => $color)
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="d-flex">
                          <select class="form-control aiz-selectpicker" 
                                  name="has_special_discount[]" 
                                  onchange="toggleSpecialDiscount(${variantCount})">
                              <option value="0">{{translate('Apply General Product Discount')}}</option>
                              <option value="1">{{translate('Apply Discount')}}</option>
                          </select>
                      </div>
                  </div>
                    ...
                    <!-- Special Discount Fields - Initially Hidden -->
                    <div id="special_discount_fields_${variantCount}" class="col-md-6 d-none">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="col-form-label">{{translate('Discount')}}</label>
                                <input type="number" name="variant_discount[]" min="0" step="0.01" class="form-control" value="0">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label">{{translate('Discount Type')}}</label>
                                <select class="form-control aiz-selectpicker" name="variant_discount_type[]">
