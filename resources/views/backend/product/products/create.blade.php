                    ...
                    <div class="form-group row d-none">
                      ...
                      <div class="col-xxl-9">
                        <input type="text" class="form-control @error('unit') is-invalid @enderror" name="unit"
                          value="Pc" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" required>
                      </div>
                    </div>
                    <!-- Weight -->
                    <div class="form-group row">
                      <label class="col-xxl-3 col-from-label fs-13">{{translate('Weight')}} <small>({{ translate('In
                          Kg') }})</small></label>
                      <div class="col-xxl-9">
                        <input type="number" class="form-control" name="weight" value="{{ old('weight') ?? 0.00 }}"
                    ...
                    <div class="form-group row d-none">
                      ...
                      <div class="col-xxl-9">
                        <input type="number" lang="en" class="form-control @error('min_qty') is-invalid @enderror"
                          name="min_qty" value="{{ old('min_qty') ?? 1 }}" placeholder="1" min="1" value="1">
            ...
            <div class="bg-white p-3 p-sm-2rem">
              ...
              <div class="w-100">
                  ...
                  <div class="col-md-8">
                    <select class="form-control aiz-selectpicker" data-live-search="true"
                      ...
                      <option value="{{ $color->code }}"
                        data-content="<span><span class='size-10px d-inline-block mr-2 rounded border' style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>">
                      </option>
                      @endforeach --}}
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="number" lang="en" min="0" value="0" step="1" placeholder="{{ translate('1') }}"
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="number" lang="en" min="0" value="0" step="1"
                        placeholder="{{ translate('Quantity') }}" name="current_stock" class="form-control" value="10">
                    </div>
                  </div>
                  <!-- SKU -->
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="text" placeholder="{{ translate('SKU') }}" name="sku" value="{{ old('sku') }}"
                        class="form-control">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row d-none">
                  ...
                  <div class="col-md-9">
                    <input type="text" placeholder="{{ translate('External link') }}" value="{{ old('external_link') }}"
                    ...
                    <div class="variant-item card p-3 mb-3" id="variant_1">
                      <div class="form-group row w-100">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="number" name="variant_price[]" step="0.01" min="0" class="form-control"
                            value="{{ old('variant_price.0') }}" required placeholder="{{translate('Enter Price')}}">
                        </div>
                        <div class="col-md-3">
                          ...
                          <input type="number" name="variant_msrp[]" step="0.01" min="0" class="form-control"
                            value="{{ old('variant_msrp.0') }}" required placeholder="{{translate('Enter MSRP')}}">
                        </div>
                        <div class="col-md-3">
                          ...
                          <input type="text" name="variant_sku[]" class="form-control"
                            value="{{ old('variant_sku.0') }}" required placeholder="{{translate('Enter SKU')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Barcode')}} <span
                              class="text-danger">*</span></label>
                          <input type="text" name="variant_barcode[]" class="form-control"
                            value="{{ old('variant_barcode.0') }}" required
                      ...
                      <div class="form-group row w-100">
                        <div class="col-md-3">
                          ...
                          <input type="number" name="variant_qty[]" min="0" class="form-control"
                            value="{{ old('variant_qty.0') }}" required placeholder="{{translate('Enter Stock')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Quantity inside a box')}} (Pcs) <span
                              class="text-danger">*</span></label>
                          <input type="number" name="variant_box_qty[]" min="0" class="form-control"
                            value="{{ old('variant_box_qty.0') }}" required
                            placeholder="{{translate('Enter box quantity')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Lead Time')}} <span
                              class="text-danger">*</span></label>
                          <input type="text" name="variant_lead_time[]" class="form-control"
                            value="{{ old('variant_lead_time.0') }}" required placeholder="{{translate('2-3 Weeks')}}">
                        </div>
                        <div class="col-md-3">
                          <label class="col-form-label">{{translate('Made in Country')}} <span
                              class="text-danger">*</span></label>
                          <select class="form-control aiz-selectpicker" data-live-search="true"
                            name="variant_made_in_country_id[]" id="variant_made_in_country_id_1" required>
                            <option value="">{{ translate('Select Country') }}</option>
                            @foreach (\App\Models\Country::orderBy('name', 'asc')->get() as $country)
                            <option value="{{ $country->id }}" @if(old('variant_made_in_country_id.0')==$country->id)
                              selected @endif>
                              {{ $country->name }}
                            </option>
                            @endforeach
                      ...
                      <div class="form-group row d-none">
                        <div class="col-md-2">
                          ...
                          <select class="form-control aiz-selectpicker" data-live-search="true"
                            data-selected-text-format="count" name="variant_color_id[]" id="variant_color_id_1">
                            <option value="">{{ translate('No Color') }}</option>
                            @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $key => $color)
                            <option value="{{ $color->id }}" @if(old('variant_color_id.0')==$color->id) selected @endif
                        ...
                        <div class="col-md-3">
                          ...
                          <select class="form-control aiz-selectpicker" name="has_special_discount[]"
                            onchange="toggleSpecialDiscount(1)">
                            <option value="0">{{translate(' Apply Genaral Product Discount')}}</option>
                        ...
                        <div id="special_discount_fields_1" class="col-md-6 d-none">
                          <div class="row">
                            <div class="col-md-6">
                      ...
                      <div class="form-group row w-100">
                        <div class="col-md-6">
                          ...
                          <select class="form-control aiz-selectpicker" name="variant_available_document[]" required>
                            ...
                            <option value="0" @if(old('variant_available_document.0')=='0' ) selected @endif>
                              {{ translate('Commercial Invoice') }}
                            </option>
                            <option value="1" @if(old('variant_available_document.0')=='1' ) selected @endif>
                              {{ translate('MSDS') }}
                            </option>
                            <option value="2" @if(old('variant_available_document.0')=='2' ) selected @endif>
                ...
                <div class="d-flex mb-4">
                  <div class="radio mar-btm mr-5 d-flex align-items-center">
                    <input id="fq_bought_select_products" type="radio" name="frequently_bought_selection_type"
                      value="product" onchange="fq_bought_product_selection_type()" checked>
...
<script type="text/javascript">
  $(document).ready(function() {
            ...
            <div class="variant-item card p-3 mb-3" id="variant_${variantCount}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <label class="col-form-label">{{translate('Special Discount')}}</label>
                        <div class="d-flex ">
                          <select class="form-control aiz-selectpicker" name="has_special_discount[]" onchange="toggleSpecialDiscount(${variantCount})">
                              <option value="0">{{translate(' Apply Genaral Product Discount')}}</option>
                              <option value="1">{{translate('Apply Discount')}}</option>
                          </select>
                        </div>
    ...
    function removeVariant(id) {
        // Don't allow removing the first variant (main product)
        if (id > 1) {
