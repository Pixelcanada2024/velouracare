...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="mb-0 h6">{{ translate('Brand Bulk Import') }}</h5> 
    </div>
    <div class="card-body">
      <div class="alert"
        ...
        <p>4. {{ translate('For images Use image id from uploaded files') }}.</p>
      </div>
      <br>
      <div class="">
        <a href="{{ static_asset('download/brand_bulk_demo.xlsx') }}" download><button
            class="btn btn-info">{{ translate('Download Excel') }}</button></a>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-horizontal" action="{{ route('brand_bulk_upload') }}" method="POST"
